...
<div class="version-banner">
  ...
  <span>Docs track the application as of <strong>v1.5.0<!-- x-release-please-version --></strong>, tested with <strong>immich-go 0.32.0</strong>. If something in the UI disagrees with a page, prefer the running app and open an issue or PR.</span>
</div>
